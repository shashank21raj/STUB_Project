...
export default function SignIn({ setForSignin }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.post("/auth/signin", formdata).then((response) => {
      ...
      <div className="h-[100vh] overflow-hidden bg-slate-950">
        <div className="flex  gap-5 justify-between h-full overflow-x-hidden overflow-y-scroll pl-[100px] bg-slate-950">
          <div className=" flex flex-grow-1 flex-shrink-1 w-[400px] flex-col py-5 text-center">
            ...
            >
              <div>
                <h1 className=" text-3xl py-8 font-normal  ">SignIn</h1>
...
//       New User! Please?{" "}
//       <span className="cursor-pointer" onClick={() => setForSignin(false)}>
//         SignUp
//       </span>
//     </p>
//   </div>
